...
import { fetchDailyHistory } from "./history/history-actions";
...
export default async function DashboardPage() {
  ...
  if (activeShift) {
    ...
    dailyCashSales = transactions
      .filter((tx) => tx.paymentMethod === "CASH")
      .reduce((sum, tx) => sum + tx.totalPrice, 0);

    dailyDebitSales = transactions
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Header */}
      <header className="flex items-center justify-between px-8 py-4 bg-(--card-bg)] border-b border-(--card-border)] backdrop-blur-md">
        ...
        <main className="flex-1 flex justify-center p-8">
          <div className="w-full max-w-140">
            <div className="mb-8">
              ...
              <p className="text-(--text-muted)] m-0 text-[0.9375rem]">Kelola shift dan transaksi Anda di sini.</p>
            </div>
            ...
            <ShiftPanel 
              ...
              dailyDebitSales={dailyDebitSales} 
            />
            ...
            <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-6 mt-6">
              ...
              <NavConfirmLink
                ...
                className="flex items-center gap-4 py-4 px-5 mt-4 bg-linear-to-br from-[rgba(99,102,241,0.1)] to-[rgba(139,92,246,0.08)] border border-[rgba(99,102,241,0.2)] rounded-2xl text-(--foreground)] no-underline transition-all duration-200 animate-[fadeInUp_0.5s_ease-out_0.2s_both] hover:bg-linear-to-br hover:from-[rgba(99,102,241,0.18)] hover:to-[rgba(139,92,246,0.14)] hover:border-[rgba(99,102,241,0.35)] hover:-translate-y-px hover:shadow-[0_8px_24px_rgba(99,102,241,0.15)]"
              >
                ...
                <div className="flex-1 flex flex-col gap-0.5">
                  ...
                  <span className="text-xs text-(--text-muted)]">Buka halaman Point of Sale</span>
                </div>
              ...
              <NavConfirmLink
                ...
                className="flex items-center gap-4 py-4 px-5 mt-4 bg-linear-to-br from-[rgba(59,130,246,0.15)] to-[rgba(37,99,235,0.1)] border border-[rgba(59,130,246,0.2)] rounded-2xl text-(--foreground)] no-underline transition-all duration-200 animate-[fadeInUp_0.5s_ease-out_0.2s_both] hover:bg-linear-to-br hover:from-[rgba(59,130,246,0.25)] hover:to-[rgba(37,99,235,0.2)] hover:border-[rgba(59,130,246,0.4)] hover:-translate-y-px hover:shadow-[0_8px_24px_rgba(59,130,246,0.15)]"
              >
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex-1 flex flex-col gap-0.5">
                  ...
                  <span className="text-xs text-(--text-muted)]">Lihat detail transaksi harian</span>
                </div>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" fill="currentColor"/>
                </svg>
